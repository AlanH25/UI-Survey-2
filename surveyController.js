...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var impressions = readData("impressions");
        var adj = readData("adj");
        var agree = readData("agree");
        var difficulty = readData("difficulty");
        var appeal = readData("appeal");
        var comments = readData("comments");

        //res.render('showResults', {results: [color, fruit, animal, agree, impressions, adj, difficulty, appeal, comments]});
        res.render('showResults', {results: [ impressions, adj, agree, difficulty, appeal, comments]});
        console.log( [ impressions, adj, agree, difficulty, appeal, comments]);
    });
